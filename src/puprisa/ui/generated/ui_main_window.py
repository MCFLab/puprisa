...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionIntensityThreshold = QAction(MainWindow)
        self.actionIntensityThreshold.setObjectName(u"actionIntensityThreshold")
        self.actionNegativeTimeDelaysPixelWise = QAction(MainWindow)
        self.actionNegativeTimeDelaysPixelWise.setObjectName(u"actionNegativeTimeDelaysPixelWise")
        self.actionNegativeTimeDelaysWholeImage = QAction(MainWindow)
        self.actionNegativeTimeDelaysWholeImage.setObjectName(u"actionNegativeTimeDelaysWholeImage")
        self.actionFirstLastNImages = QAction(MainWindow)
        self.actionFirstLastNImages.setObjectName(u"actionFirstLastNImages")
        ...
        self.actionDownsampling = QAction(MainWindow)
        self.actionDownsampling.setObjectName(u"actionDownsampling")
        self.actionUnionAllMasks = QAction(MainWindow)
        self.actionUnionAllMasks.setObjectName(u"actionUnionAllMasks")
        ...
        self.menuProcess.addAction(self.actionIntensityThreshold)
        self.menuProcess.addAction(self.actionDownsampling)
        self.menuBackground_Subtraction.addAction(self.actionNegativeTimeDelaysPixelWise)
        self.menuBackground_Subtraction.addAction(self.actionNegativeTimeDelaysWholeImage)
        self.menuBackground_Subtraction.addSeparator()
        self.menuBackground_Subtraction.addAction(self.actionFirstLastNImages)
        self.menuBackground_Subtraction.addSeparator()
        self.menuBackground_Subtraction.addAction(self.actionResetBackgroundSubtraction)
        self.menuROI.addAction(self.actionImportROI)
        self.menuROI.addAction(self.actionExportROI)
        ...
        self.menuMask.addAction(self.actionUnionAllMasks)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionIntensityThreshold.setText(QCoreApplication.translate("MainWindow", u"Intensity Threshold...", None))
        self.actionNegativeTimeDelaysPixelWise.setText(QCoreApplication.translate("MainWindow", u"Negative Time Delays (pixel-wise)", None))
        self.actionNegativeTimeDelaysWholeImage.setText(QCoreApplication.translate("MainWindow", u"Negative Time Delays (whole-image)", None))
        self.actionFirstLastNImages.setText(QCoreApplication.translate("MainWindow", u"First/Last N Images...", None))
        ...
        self.actionDownsampling.setText(QCoreApplication.translate("MainWindow", u"Downsampling...", None))
        self.actionUnionAllMasks.setText(QCoreApplication.translate("MainWindow", u"Union All Masks", None))
        ...
        self.roiShapeComboBox.setItemText(1, QCoreApplication.translate("MainWindow", u"Square", None))
        self.roiShapeComboBox.setItemText(2, QCoreApplication.translate("MainWindow", u"Circle", None))
        self.roiShapeComboBox.setItemText(3, QCoreApplication.translate("MainWindow", u"Ellipse", None))
        self.roiShapeComboBox.setItemText(4, QCoreApplication.translate("MainWindow", u"Polygon", None))
