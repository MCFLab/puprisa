...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionExportSelectedROI = QAction(MainWindow)
        ...
        self.menuROI.addAction(self.actionExportSelectedROI)
        ...
        self.menuMask.addAction(self.actionMaskZeroPixels)
        ...
        self.menuCurve.addAction(self.actionSpectrum)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionExportSelectedROI.setText(QCoreApplication.translate("MainWindow", u"Export Selected ROI...", None))
