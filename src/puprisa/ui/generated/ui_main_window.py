...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionImport_ROI = QAction(MainWindow)
        self.actionImport_ROI.setObjectName(u"actionImport_ROI")
        self.actionExport_Selected_ROI = QAction(MainWindow)
        self.actionExport_Selected_ROI.setObjectName(u"actionExport_Selected_ROI")
        self.actionExport_ROI = QAction(MainWindow)
        self.actionExport_ROI.setObjectName(u"actionExport_ROI")
        ...
        self.actionRIN = QAction(MainWindow)
        self.actionRIN.setObjectName(u"actionRIN")
        ...
        self.menuROI.addAction(self.actionImport_ROI)
        self.menuROI.addAction(self.actionExport_Selected_ROI)
        self.menuROI.addAction(self.actionExport_ROI)
        ...
        self.menuCurve.addAction(self.actionFFT)
        self.menuCurve.addAction(self.actionPSD)
        self.menuCurve.addAction(self.actionRIN)
        self.menuCurve.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionImport_ROI.setText(QCoreApplication.translate("MainWindow", u"Import ROI...", None))
        self.actionExport_Selected_ROI.setText(QCoreApplication.translate("MainWindow", u"Export Selected ROI...", None))
        self.actionExport_ROI.setText(QCoreApplication.translate("MainWindow", u"Export ROI...", None))
        self.actionPSD.setText(QCoreApplication.translate("MainWindow", u"Calculate PSD...", None))
        self.actionFFT.setText(QCoreApplication.translate("MainWindow", u"Calculate FFT...", None))
        self.actionRIN.setText(QCoreApplication.translate("MainWindow", u"Calculate RIN...", None))
