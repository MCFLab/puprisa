...
class Ui_PhasorWindow(object):
    def setupUi(self, PhasorWindow):
        ...
        self.actionEditROI = QAction(PhasorWindow)
        ...
        self.actionImport_ROI = QAction(PhasorWindow)
        self.actionImport_ROI.setObjectName(u"actionImport_ROI")
        self.actionExport_ROI = QAction(PhasorWindow)
        self.actionExport_ROI.setObjectName(u"actionExport_ROI")
        self.actionExport_Selected_ROI = QAction(PhasorWindow)
    ...
    def retranslateUi(self, PhasorWindow):
        ...
        self.actionEditROI.setText(QCoreApplication.translate("PhasorWindow", u"Edit ROI...", None))
        self.actionCurveFit.setText(QCoreApplication.translate("PhasorWindow", u"Curve Fit...", None))
        self.actionImport_ROI.setText(QCoreApplication.translate("PhasorWindow", u"Import ROI...", None))
        self.actionExport_ROI.setText(QCoreApplication.translate("PhasorWindow", u"Export ROI...", None))
        self.actionExport_Selected_ROI.setText(QCoreApplication.translate("PhasorWindow", u"Export Selected ROI...", None))
